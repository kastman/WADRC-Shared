...
describe "mri_scans/edit.html.erb" do
  before(:each) do
  ...
  it "renders the edit mri_scan form" do
    render

    rendered.should have_selector("form", :action => mri_scan_path(@mri_scan), :method => "post") do |form|
