...
describe "scan_tasks/new.html.erb" do
  before(:each) do
    assign(:scan_task, stub_model(ScanTask,
      :appointment => nil,
  ...
  it "renders new scan_task form" do
    render

    rendered.should have_selector("form", :action => scan_tasks_path, :method => "post") do |form|
